 ...
 */
final class Version20190918141534 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE password_forget DROP password');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activity CHANGE streetnum streetnum INT DEFAULT NULL, CHANGE note note INT DEFAULT NULL');
        $this->addSql('ALTER TABLE password_forget ADD password VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
