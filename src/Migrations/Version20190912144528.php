 ...
 */
final class Version20190912144528 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sortie DROP photo, DROP address, DROP phone, DROP date');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD photo VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, ADD address VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, ADD phone VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, ADD date DATETIME DEFAULT \'NULL\'');
